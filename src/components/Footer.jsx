...
const Footer = () => {
  return (
    <motion.footer
      className="bg-gradient-to-r from-blue-300 to-blue-500 text-white py-6 px-4 text-center"
    ...
    >
      ...
      >
        &copy; {new Date().getFullYear()} <span className="font-semibold">Stop Watch</span> | All Rights Reserved
      </motion.div>
